...
const providerConfig = {
    ...
    github: {
        ...
        focusRing: 'focus:ring-2 focus:ring-gray-500 focus:ring-offset-2',
    },
    facebook: {
        name: 'Facebook',
        textColor: 'text-white',
...
const handleLogin = () => {
    ...
    router.visit(`/auth/${props.provider}`);
};
</script>
...
<template>
    ...
    >
        <!-- Google Icon -->
        <svg v-if="provider === 'google'" class="h-5 w-5" viewBox="0 0 24 24">
            <path
