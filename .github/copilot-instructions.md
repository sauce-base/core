...
- Frontend SPA: `resources/js/` (layouts, pages, composables). Keep directory names lowercase (components, pages, layouts, composables).
...
- Add frontend components: put Vue pages under `modules/<Module>/resources/js/pages/` or `resources/js/pages/`; use lowercase folder names. Create composables under `resources/js/composables` or module-specific composables under the module's resources.
